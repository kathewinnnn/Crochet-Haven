...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .ch-summary-total-lbl {
    font-size: 1rem;
    font-weight: 700;
    color: var(--charcoal);
  }

  .ch-summary-total-price {
    font-family: 'Playfair Display', serif;
    font-size: 1.7rem;
    font-weight: 800;
    color: var(--rose);
  ...
  @media (max-width: 900px) {
    ...
    .ch-cart-body { padding: 36px 30px 60px; }
    .ch-cart-layout { grid-template-columns: 1fr; }
    .ch-summary-panel { position: static; max-width: 480px; }
    .ch-footer { flex-direction: column; gap: 12px; text-align: center; padding: 28px 30px; }
  }

  @media (max-width: 580px) {
    .ch-cart-item { flex-wrap: wrap; gap: 14px; }
    .ch-item-img { width: 70px; height: 70px; }
    .ch-item-controls { align-items: flex-start; width: 100%; }
  }
`;
