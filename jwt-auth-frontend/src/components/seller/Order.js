...
const orderStyles = `
  ...
  .ch-logo-yarn { font-size: 2.8rem; animation: sway 4s ease-in-out infinite; display: inline-block; transform-origin: bottom center; }
  @keyframes sway { 0%, 100% { transform: rotate(-4deg); } 50% { transform: rotate(4deg); } }
  .ch-logo-text { font-family: 'Playfair Display', serif; font-size: 2rem; font-weight: 800; letter-spacing: -0.02em; color: var(--charcoal); line-height: 1; }
  ...
  .ch-orders { font-family: 'Lato', sans-serif; color: var(--charcoal); padding: 52px 56px; min-height: 100vh; }
  .ch-orders-header { margin-bottom: 36px; }

  .ch-orders-eyebrow { display: inline-flex; align-items: center; gap: 10px; font-size: 0.7rem; letter-spacing: 0.24em; text-transform: uppercase; color: var(--terracotta); font-weight: 700; margin-bottom: 10px; }
  .ch-orders-eyebrow::before { content: ''; display: block; width: 28px; height: 1.5px; background: var(--terracotta); }

  .ch-orders-title { font-family: 'Playfair Display', serif; font-size: 2.2rem; font-weight: 800; color: var(--charcoal); letter-spacing: -0.03em; line-height: 1.1; margin-bottom: 8px; }
  .ch-orders-title em { font-style: italic; color: var(--rose); }

  .ch-notification { position: fixed; top: 24px; right: 24px; background: var(--charcoal); color: #fff; border-radius: 6px; padding: 18px 20px; min-width: 300px; max-width: 380px; display: flex; align-items: flex-start; gap: 14px; box-shadow: 0 20px 60px rgba(44, 36, 32, 0.3); z-index: 9990; border-left: 4px solid var(--rose); animation: slideInRight 0.3s ease; }
  @keyframes slideInRight { from { opacity: 0; transform: translateX(40px); } to { opacity: 1; transform: translateX(0); } }
  .ch-notification-icon { font-size: 1.4rem; flex-shrink: 0; margin-top: 2px; }
  .ch-notification-body h4 { font-family: 'Playfair Display', serif; font-size: 0.92rem; font-weight: 700; color: var(--amber); margin-bottom: 4px; }
  .ch-notification-body p { font-size: 0.78rem; color: rgba(255,255,255,0.75); line-height: 1.5; font-weight: 300; margin: 0; }
  .ch-notification-close { background: none; border: none; color: rgba(255,255,255,0.5); font-size: 1.2rem; cursor: pointer; margin-left: auto; padding: 0; line-height: 1; flex-shrink: 0; transition: color 0.15s ease; }
  .ch-notification-close:hover { color: #fff; }

  .ch-order-filters { display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 28px; }
  .ch-filter-btn { padding: 8px 18px; background: transparent; border: 1.5px solid var(--border); border-radius: 100px; color: var(--muted); font-family: 'Lato', sans-serif; font-size: 0.75rem; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; cursor: pointer; transition: all 0.18s ease; }
  ...
  .ch-orders-table-wrap { background: var(--warm-white); border: 1px solid var(--border); border-radius: 4px; overflow: hidden; margin-bottom: 36px; overflow-x: auto; }

  .ch-orders-table { width: 100%; border-collapse: collapse; min-width: 700px; }
  .ch-orders-table thead tr { background: rgba(253, 246, 236, 0.8); }
  .ch-orders-table th { text-align: left; padding: 12px 18px; font-size: 0.62rem; letter-spacing: 0.18em; text-transform: uppercase; color: var(--muted); font-weight: 700; border-bottom: 1px solid var(--border); white-space: nowrap; }
  .ch-orders-table tbody tr { border-bottom: 1px solid rgba(212, 115, 94, 0.07); transition: background 0.14s ease; }
  .ch-orders-table tbody tr:last-child { border-bottom: none; }
  .ch-orders-table tbody tr:hover { background: rgba(253, 246, 236, 0.5); }
  .ch-orders-table td { padding: 13px 18px; font-size: 0.82rem; color: var(--charcoal); vertical-align: middle; }

  .ch-order-id { font-family: 'Playfair Display', serif; font-weight: 700; font-size: 0.88rem; color: var(--charcoal); }
  .ch-order-thumb { width: 44px; height: 44px; border-radius: 3px; object-fit: cover; border: 1px solid var(--border); display: block; }
  .ch-no-img { width: 44px; height: 44px; border-radius: 3px; background: rgba(212, 115, 94, 0.07); display: flex; align-items: center; justify-content: center; font-size: 0.65rem; color: var(--muted); text-align: center; line-height: 1.2; }

  .ch-customer-block strong { display: block; font-weight: 700; font-size: 0.84rem; color: var(--charcoal); margin-bottom: 2px; }
  .ch-customer-block span { display: block; font-size: 0.72rem; color: var(--muted); font-weight: 300; line-height: 1.4; }

  .ch-product-item-row { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; font-size: 0.8rem; }
  ...
  .ch-order-total { font-family: 'Playfair Display', serif; font-weight: 700; font-size: 0.92rem; color: var(--charcoal); }
  .ch-order-date { font-size: 0.76rem; color: var(--muted); font-weight: 300; white-space: nowrap; }
  .ch-order-note { font-size: 0.76rem; color: var(--muted); font-style: italic; font-weight: 300; max-width: 140px; }

  .ch-status-badge { display: inline-block; padding: 4px 10px; border-radius: 2px; font-size: 0.65rem; font-weight: 700; letter-spacing: 0.12em; text-transform: uppercase; white-space: nowrap; }
  ...
  .ch-payment-badge { display: inline-block; padding: 3px 8px; border-radius: 2px; font-size: 0.6rem; font-weight: 700; letter-spacing: 0.1em; text-transform: uppercase; white-space: nowrap; }
  ...
  .ch-status-select { padding: 7px 10px; border: 1.5px solid var(--border); border-radius: 3px; background: var(--cream); color: var(--charcoal); font-family: 'Lato', sans-serif; font-size: 0.76rem; font-weight: 400; cursor: pointer; outline: none; transition: border-color 0.15s ease; min-width: 130px; }
  .ch-status-select:focus { border-color: var(--rose); }

  .ch-order-cards { display: none; flex-direction: column; gap: 16px; }
  .ch-order-card { background: var(--warm-white); border: 1px solid var(--border); border-radius: 4px; overflow: hidden; }
  .ch-order-card-head { display: flex; align-items: center; justify-content: space-between; padding: 16px 18px; border-bottom: 1px solid var(--border); background: rgba(253, 246, 236, 0.6); }
  .ch-order-card-id { font-family: 'Playfair Display', serif; font-size: 0.95rem; font-weight: 700; color: var(--charcoal); }
  .ch-order-card-body { padding: 16px 18px; display: flex; flex-direction: column; gap: 8px; font-size: 0.82rem; }
  .ch-order-card-body p { margin: 0; color: var(--charcoal); }
  .ch-order-card-body p span { color: var(--muted); font-weight: 300; }
  .ch-order-items-preview { border-top: 1px solid var(--border); padding-top: 10px; margin-top: 4px; display: flex; flex-direction: column; gap: 5px; }
  .ch-order-item-line { display: flex; justify-content: space-between; font-size: 0.78rem; }
  .ch-order-item-line span:last-child { font-family: 'Playfair Display', serif; font-weight: 600; }
  .ch-order-card-actions { padding: 14px 18px; border-top: 1px solid var(--border); display: flex; align-items: center; gap: 10px; }
  .ch-order-card-actions label { font-size: 0.7rem; letter-spacing: 0.14em; text-transform: uppercase; color: var(--muted); font-weight: 700; }

  .ch-orders-empty { padding: 60px 28px; text-align: center; color: var(--muted); }
  .ch-orders-empty-emoji { font-size: 3rem; display: block; margin-bottom: 12px; opacity: 0.4; }

  .ch-orders-loading { display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 300px; gap: 16px; color: var(--muted); font-size: 0.85rem; }
  .ch-orders-loader { width: 36px; height: 36px; border: 2.5px solid rgba(232, 114, 138, 0.2); border-top-color: var(--rose); border-radius: 50%; animation: chSpin 0.8s linear infinite; }
  ...
  .ch-modal-box { background: var(--warm-white); border-radius: 6px; padding: 40px 36px; max-width: 420px; width: 90%; text-align: center; box-shadow: 0 30px 80px rgba(44, 36, 32, 0.22); border: 1px solid var(--border); font-family: 'Lato', sans-serif; animation: modalIn 0.22s ease; }
  @keyframes modalIn { from { opacity: 0; transform: translateY(14px) scale(0.96); } to { opacity: 1; transform: translateY(0) scale(1); } }
  .ch-modal-title { font-family: 'Playfair Display', serif; font-size: 1.3rem; font-weight: 700; color: var(--charcoal); margin-bottom: 10px; }
  .ch-modal-desc { font-size: 0.85rem; color: var(--muted); line-height: 1.65; margin-bottom: 28px; font-weight: 300; }
  ...
  /* ─── FOOTER ─── */
  .ch-footer { position: relative; z-index: 1; background: var(--warm-white); border-top: 1px solid var(--border); padding: 32px 60px; display: flex; align-items: center; justify-content: space-between; margin-left: -5%; width: 98.5%; margin-bottom: -17.5px; }
  ...
  @media (min-width: 769px) and (max-width: 1024px) {
    ...
    .ch-orders { padding: 36px 32px; }
    .ch-orders-title { font-size: 1.9rem; }
    .ch-orders-table-wrap { overflow-x: auto; }
  ...
  @media (max-width: 768px) {
    ...
    .ch-orders { padding: 80px 16px 24px; }
    .ch-orders-title { font-size: 1.6rem; }
    .ch-orders-header { margin-bottom: 20px; }
    .ch-order-filters { gap: 6px; margin-bottom: 20px; }
    .ch-filter-btn { padding: 6px 12px; font-size: 0.68rem; }
    .ch-orders-table-wrap { display: none; }
    .ch-order-cards { display: flex; }
    .ch-notification { min-width: unset; max-width: calc(100vw - 32px); top: 72px; right: 16px; left: 16px; }
    .ch-footer { margin-left: 0; width: 100%; padding: 20px 16px; flex-direction: column; gap: 6px; text-align: center; }
  }
`;
...
const Order = () => {
  ...
  const getLastSeenOrder = () => { const saved = localStorage.getItem("lastSeenOrder"); return saved ? JSON.parse(saved) : { id: null, timestamp: null }; };
  const saveLastSeenOrder = (id, timestamp) => { localStorage.setItem("lastSeenOrder", JSON.stringify({ id, timestamp })); };
  ...
  useEffect(() => {
    ...
    return () => { clearInterval(pollInterval); window.removeEventListener("ordersUpdated", onOrdersUpdated); window.removeEventListener("storage", onStorage); };
  }, []);

  const showNewOrderNotification = (order) => {
    setNewOrderNotification({ id: order.id, customer: order.customer?.fullName || "Unknown Customer", total: order.total, itemCount: order.items?.length || 1 });
  ...
  const updateStatus = async (id, status) => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/orders/${id}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ status }) });
      if (response.ok) {
  ...
  const confirmCancel = async () => {
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/orders/${orderId}`, { method: "PUT", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ status: "Cancelled" }) });
      if (response.ok) {
  ...
  const isDigitalPayment = (method) => method === 'gcash' || method === 'paymaya' || method === 'card';

  useEffect(() => () => { if (notificationTimeoutRef.current) clearTimeout(notificationTimeoutRef.current); }, []);

  if (loading) return (<div className="ch-orders"><style>{orderStyles}</style><div className="ch-orders-loading"><div className="ch-orders-loader" /><span>Loading orders…</span></div></div>);

  if (error) return (
    <div className="ch-orders">
      <style>{orderStyles}</style>
      <div className="ch-orders-header"><p className="ch-orders-eyebrow">Management</p><h1 className="ch-orders-title">Order <em>Management</em></h1></div>
      ...
      <div className="ch-orders">
        ...
        <div className="ch-orders-table-wrap">
          <table className="ch-orders-table">
            <thead>
              <tr>
                <th>Order ID</th><th>Image</th><th>Customer</th><th>Product</th><th>Total</th><th>Date</th><th>Status</th><th>Payment</th><th>Notes</th><th>Actions</th>
              </tr>
            </thead>
            <tbody>
                  ...
                  return items.map((item, itemIndex) => {
                    ...
                    return (
                      <tr key={`${order.id}-${itemIndex}`}>
                        ...
                        <td><div className="ch-product-item-row"><span className="ch-item-name">{item.name}</span><span className="ch-item-qty">×{item.quantity}</span><span className="ch-item-price">₱{formatPrice(item.price)}</span><span className="ch-item-sub">= ₱{formatPrice(subtotal)}</span></div></td>
                        ...
                        <td>{isFirst && <span className={`ch-payment-badge ${isDigitalPayment(order.paymentMethod) ? 'ch-payment-paid' : 'ch-payment-unpaid'}`}>{isDigitalPayment(order.paymentMethod) ? 'Paid' : order.paymentMethod || 'COD'}</span>}</td>
            ...
            sortedOrders.map((order) => (
              <div key={order.id} className="ch-order-card">
                ...
                <div className="ch-order-card-head" style={{ marginTop: '8px', paddingTop: '8px', borderTop: '1px solid var(--border)' }}>
                  ...
                  <span className={`ch-payment-badge ${isDigitalPayment(order.paymentMethod) ? 'ch-payment-paid' : 'ch-payment-unpaid'}`}>
                    {isDigitalPayment(order.paymentMethod) ? 'Paid' : order.paymentMethod || 'COD'}
                  </span>
                </div>
        ...
        {cancelModal.show && (
          <div className="ch-modal-backdrop" onClick={(e) => e.target === e.currentTarget && setCancelModal({ show: false, orderId: null })}>
            <div className="ch-modal-box">
              ...
              <p className="ch-modal-desc">This action cannot be undone. The order will be marked as cancelled.</p>
