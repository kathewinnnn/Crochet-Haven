...
const loginStyles = `
  ...
  /* pink-50:#fdf2f8  pink-100:#fce7f3  pink-200:#fbcfe8  pink-300:#f9a8d4
     pink-400:#f472b6  pink-500:#ec4899  pink-700:#be185d
     gray-100:#f3f4f6  gray-400:#9ca3af  gray-500:#6b7280  gray-600:#555
     gray-700:#666     gray-800:#333     gray-900:#1f2937               */
  ...
  .overlay__backdrop {
    ...
    background: linear-gradient(
      ...
      rgba(252, 231, 243, 0.98) 50%,
      rgba(251, 207, 232, 0.96) 100%
    );
  ...
  .overlay__card {
    ...
    border-radius: 24px;
    box-shadow:
      0 32px 80px rgba(249, 168, 212, 0.45),
      0 0 0 1px rgba(249, 168, 212, 0.15);
  ...
  .overlay__check-circle polyline {
  ...
  .overlay__progress-bar {
    ...
    animation:
      progressFill 1.8s cubic-bezier(0.4, 0, 0.2, 1) forwards,
  ...
  .login__button {
    ...
    cursor: pointer;
    transition: all 0.3s ease;
    box-shadow: 0 4px 15px rgba(249, 168, 212, 0.5);
    font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
    opacity: 1;
    transform: none;
    margin-top: 10px;
  ...
  <div className="overlay__backdrop">
    <div className="overlay__card">
      ...
      <div className="overlay__dots">
        {[0, 1, 2].map((i) => (
          <span key={i} className="overlay__dot" />
        ))}
      </div>
    </div>
  </div>
